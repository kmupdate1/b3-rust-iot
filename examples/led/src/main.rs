...
async fn main(spawner: Spawner) {
    ...
    let fw = aligned_bytes!("../../../vendor/embassy/cyw43-firmware/43439A0.bin");
    let clm = aligned_bytes!("../../../vendor/embassy/cyw43-firmware/43439A0_clm.bin");
    let nvram = aligned_bytes!("../../../vendor/embassy/cyw43-firmware/nvram_rp2040.bin");
